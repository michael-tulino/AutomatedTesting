...
public class AddApplicationInIADCTest {
  ...
  private static final String ENVIRONMENT_KEY_TOOLTIP =
      "This is a key specifying the environment for this application. Use the base url before appiancloud.com. For example, for ignytedemo.appiancloud.com, the key should be ignytedemo.";
  private static final String ADMIN_GROUP_ID_TOOLTIP = "Group ID for the Admin Group of the application to add. Example: 1146";
  ...
  void addApplicationSavesAndAppearsInApplicationsGridWithExpectedFieldValues() {
    ...
    fixture.populateFieldWithTooltipWith(ENVIRONMENT_KEY_TOOLTIP, new String[] { environmentKey });
    fixture.populateFieldWithTooltipWith(ADMIN_GROUP_ID_TOOLTIP, new String[] { adminGroupId });
